//
//  RZCartoonVipHomeViewController.swift
//  CartoonSwift
//
...
import UIKit
import MJRefresh
class RZCartoonVipHomeViewController: RZCartoonBaseViewController {

    private var newVipList =  [CartoonHopeModel]()
    ...
    func getVipListFromSever() {
        RZCartoonHomePageVM().getVipList { (code, msg, json) in
            self.collection.mj_header.endRefreshing()
            if code == 1 {
                print(json)
                let model = json as! CartoonHopeBaseModel
                self.newVipList = model.newVipList ?? []
                for item in self.newVipList {
...
extension RZCartoonVipHomeViewController : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    
    func numberOfSections(in collectionView: UICollectionView) -> Int {
        return self.newVipList.count
    }
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        let model = self.newVipList[section]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let model = self.newVipList[indexPath.section]
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let basemodel = self.newVipList[indexPath.section]
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader {
            ...
            header.model = self.newVipList[indexPath.section]
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForFooterInSection section: Int) -> CGSize {
        return section == self.newVipList.count - 1 ? CGSize.zero : CGSize(width: kScreenWidth, height: 15)
    }
